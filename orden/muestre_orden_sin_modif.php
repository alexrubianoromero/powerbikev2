...
saldo,
estado
 from $tabla14  where   tipo_orden < '2'   order by id desc";
...
<Div id="contenidos123" align="center">
		...
		while($ordenes = mysql_fetch_array($consulta_ordenes))
			{
				...
				if($ordenes['10']<20){
					echo  '<td><h3>';
					echo '<a href="../facturas/crear_factura_de_orden_nuevo.php?idorden='.$ordenes['0'].'" >Facturar</a>';
					echo '</h3></td>';
				}	
				else{
					echo  '<td><h3>';
				...
				echo '</h3>';
				echo '<h3>';
				echo '<a href="orden_imprimir_pos.php?idorden='.$ordenes['0'].'"  target="_blank" >Hoja_Completa</a>';
				echo '</h3>';
				echo '</td>'; 
					//////////////////
					/*
