...
$sql_maxima_remision  = "select contaor,id_empresa from $tabla10   ";
		 ...
		 $ordenpan = $maximoid['contaor'] + 1 ;  
				...
				$id_empresa = $maximoid['id_empresa'];
				// echo $id_empresa;
				// die();
...
while($items  =  mysql_fetch_array($consulta_temporal_definitivo))
		{
			...
			values ('".$id_orden['id']."','".$items[2]."','".$items[3]."','".$items[4]."','".$items[5]."','".$items[7]."','".$id_empresa."','0')";
			...
			$sql_valor_existente = "select codigo_producto,cantidad from $tabla12 where codigo_producto =  '".$items[2]."'   and id_empresa = '".$id_empresa."'    ";	
			...
			$sql_actualizar_inventario = "update $tabla12 set cantidad = '".$valor_final_inventario."'   
					 where codigo_producto = '".$items[2]."'  and id_empresa = '".$id_empresa."'  ";
...
////////////////////////////////////////////////////////
		...
		$sql_borrar_temporal = "delete from $tabla18 where id_empresa = '".$id_empresa."' ";
...
$sql_datos_empresa = "select ruta_imagen,nombre,tipo_taller,identi,telefonos,direccion from $tabla10 where id_empresa = '".$id_empresa."'  ";  
...
while ($nombres2_items = mysql_fetch_assoc($consulta_nombres_items))
{
	...
	//echo '<br>valor del id_item'.$id_item.'fin de valor ';
				...
				values ('".$id_empresa."','".$id_orden['id']."','".$id_item."','".$_POST[$id_item]."','".$_POST[$palabra_cantidad]."')";
