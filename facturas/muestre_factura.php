	...
	echo '<td><h3>TIPO FACTURA</h3></td><td><h3>VISTA IMPRESION</h3></td>'; 
		while($ordenes = mysql_fetch_array($consulta_ordenes))
			{ 
				...
				{
				echo  '<td><h3>';
				echo '<a href="../facturas/factura_imprimir.php?id_factura='.$ordenes['3'].'"  target = "_blank" >Impresion</a>';
				echo '<br>';
				echo '<a href="../facturas/factura_imprimir_pos.php?id_factura='.$ordenes['3'].'"  target = "_blank" >Pos</a>';
				echo '</h3></td>'; 
				}
				if($ordenes['5']==8)
				{
