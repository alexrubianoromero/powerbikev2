...
echo "<a href='../facturas/factura_imprimir_pos.php?id_factura=".$id_factura['id_factura']."'  target='_blank' ><h2>Vista Impresion Pos</h2></a>";
echo '<br><br>';
echo "<a href='../facturas/factura_imprimir.php?id_factura=".$id_factura['id_factura']."'  target='_blank' ><h2>Vista Impresion Factura</h2></a>";
