...
if(isset($_REQUEST['id_cxp']))
   ...
   $saldo_actual_empresa = "select * from empresa ";
   $consulta_saldo_actual_empresa = mysql_query($saldo_actual_empresa,$conexion);
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td><?php echo $letrero_de_donde_viene;  ?>  SALDO ACTUAL EN CAJA </td>
    <td><?php  echo $numero_actual['saldocajamenor']  ?> </td> 
